...
## Project Structure
    ...
    ├── apexhomesearch_39043  # Django project configurations
...
1. Clone this repo and `cd apexhomesearch_39043`
...
2. Clone this repo and `cd apexhomesearch_39043`
